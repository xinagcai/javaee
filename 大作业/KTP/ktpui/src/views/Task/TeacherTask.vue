<template>
   <div class="wrapper">
    ...
    <div class="info-top">
      <div class="topm">
        ...
        <div class="box-box">
          ...
          <ul>
            <li  style="border-radius: 3px"><div @click="gotoCourseMember">成员: {{course.members + 1}}</div></li>
            <li  style="border-radius: 3px"><div>成绩管理</div></li>
          </ul>
    ...
    <div class="content">
      <el-button type="primary" @click="deliver(1)" plain>发布作业</el-button>
        ...
        <div class="homework-box" v-show="!editing[task.tno]">
          <div class="homework-inner">
            <div class="unique-top">
              <div class="work-type" >
                <span class="work-type-first-span" style="border-radius: 3px">个人作业</span>
...
<script>
  ...
  export default {
    name: "TeacherTask",
    components: {PersonalDeliver, WorkNav},
    data() {
      return {
        showDeliver: 0,
        tasks: [],
...
<style scoped>
  ...
  .info-top {
    ...
    width: 96%;
    height: 200px;
    background: url("../../assets/img/30 (1).png") center center no-repeat ;
